...
<body style="background:url(../images/register/bg.jpg) no-repeat">
...
<div class="right">
<input type="button" class="btn btn-success" style="width:170px;height:170px;margin-left:40px;" id="submit" onclick="adaptValue()" value="完成注册" disabled="disabled"/>
...
$.post("register_check.jsp",{Name:name,Password:password,Email:email},function(data){
