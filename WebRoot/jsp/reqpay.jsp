...
// 商家密钥
	String nodeAuthorizationURL = formatString

(Configuration.getInstance().getValue("onlinePaymentReqURL"));  	
...
<html>
	...
	<body>
	<div style="margin:200px auto;width:200px;height:200px;">
		<form name="yeepay" action='https://www.yeepay.com/app-merchant-proxy/node' method='POST' target="_blank">
			...
			<input type='submit' class="btn btn-success" value="再次确认支付"/>
		</form>
		</div>
	</body>
</html>
